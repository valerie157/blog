                    ...
                    <tbody>
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <a href="#" class="block py-2 px-4 hover:bg-black-100 dark:hover:bg-gray-600 dark:hover:text-white">Show</a>

                                </button>
                                <button id="apple-imac-27-dropdown-button"class="inline-flex items-center  p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
                                <a href="#" class="block py-2 px-4 hover:bg-black-100 dark:hover:bg-gray-600 dark:hover:text-white">Delete</a>

                                </button>
                                <button id="apple-imac-27-dropdown-button"class="inline-flex items-center  p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
                                <a href="#" class="block py-2 px-4 hover:bg-black-100 dark:hover:bg-gray-600 dark:hover:text-white">edit</a>
